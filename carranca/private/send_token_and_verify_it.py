...
def send_token_and_verify_it(email: str, name: str = "") -> str:
    # Token already sent, now Verify it
    ...
    try:
        ...
        task_code += 1
        ui_db_texts[UITextsKeys.Form.submit_route] = private_route("auto_email_user")
        task_code += 1
